...
const rowToRendimiento = (r) => ({
  ...
  fecha:           r.fecha             || "",
  proveedor:       r.proveedor         || "",
  kilosIngresados:   Number(r.kilos_ingresados)    || 0,
  kilosNoProcesados: Number(r.kilos_no_procesados) || 0,
  ...
  pesoDelMonte:    Number(r.peso_del_monte)   || 16.8,
...
export function useContenedores() {
  ...
  const guardarRendimiento = useCallback(async (form, editId = null) => {
    ...
    const row = {
      ...
      fecha:            form.fecha,
      proveedor:        form.proveedor        || null,
      kilos_ingresados:    Number(form.kilosIngresados)    || 0,
      kilos_no_procesados: Number(form.kilosNoProcesados)  || 0,
      ...
      peso_del_monte:   Number(form.pesoDelMonte)    || 16.8,
